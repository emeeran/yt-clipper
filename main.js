...
`}};var S=require("obsidian"),p="ytc-settings",de=class extends S.PluginSettingTab{constructor(e,r){super(e,r.plugin);this.options=r;this.validationErrors=[];this.settings={...r.plugin.settings},this.secureConfig=new le(this.settings)}display(){let{containerEl:e}=this;e.empty(),e.addClass(`${p}-container`),this.injectStyles(),this.createHeader(),this.createAPISection(),this.createAISection(),this.createOutputSection(),this.createAdvancedSection(),this.createHelpSection()}injectStyles(){if(document.getElementById(`${p}-styles`))return;let e=document.createElement("style");e.id=`${p}-styles`,e.textContent=`
            .${p}-container {
                max-width: 700px;
                margin: 0 auto;
            }
