...
`}};var R=require("obsidian"),m="ytc-settings",Ae=class extends R.PluginSettingTab{constructor(e,r){super(e,r.plugin);this.options=r;this.validationErrors=[];this.drawerStates=new Map;this.DRAWER_STATES_KEY="ytc-settings-drawer-states";this.settings={...r.plugin.settings},this.secureConfig=new Se(this.settings),this.loadDrawerStates()}display(){let{containerEl:e}=this;e.empty(),e.addClass(`${m}-container`),this.injectStyles(),this.createHeader(),this.createAPISection(),this.createAISection(),this.createOutputSection(),this.createAdvancedSection(),this.createHelpSection()}injectStyles(){if(document.getElementById(`${m}-styles`))return;let e=document.createElement("style");e.id=`${m}-styles`,e.textContent=`
        ...
        `;let C=p.createDiv();C.style.cssText=`
            display: flex;
            gap: 2px;
        `;let T=C.createEl("button");this.refreshButton=T,T.innerHTML="\u{1F504}",T.title="Refresh (Shift+click to force)",T.style.cssText=`
            background: none;
            border: none;
            cursor: pointer;
            font-size: 0.75rem;
        ...
        `,this.fallbackToggle=o.createEl("input",{type:"checkbox"}),this.fallbackToggle.checked=(h=this.options.enableAutoFallback)!=null?h:!0,this.autoFallbackEnabled=this.fallbackToggle.checked,this.fallbackToggle.style.cssText=`
            ...
            transition: background 0.2s ease;
            outline: none;
        `;let a=()=>{var p;(p=this.fallbackToggle)!=null&&p.checked?this.fallbackToggle.style.background="var(--interactive-accent)":this.fallbackToggle.style.background="var(--background-modifier-border)"},c=o.createDiv();c.style.cssText=`
            position: absolute;
            top: 2px;
            left: 2px;
            width: 12px;
        ...
        `;let r=e.createDiv();r.style.cssText=`
            ...
            padding: 4px;
        `,r.innerHTML=this.isLightTheme?"\u2600\uFE0F":"\u{1F319}",r.title=this.isLightTheme?"Switch to dark mode":"Switch to light mode",r.addEventListener("mouseenter",()=>{r.style.opacity="1"}),r.addEventListener("mouseleave",()=>{r.style.opacity="0.6"});let i=s=>{this.isLightTheme=s,r.innerHTML=s?"\u2600\uFE0F":"\u{1F319}",r.title=s?"Switch to dark mode":"Switch to light mode",this.applyTheme(s),localStorage.setItem("ytc-theme-mode",s?"light":"dark")};r.addEventListener("click",()=>{i(!this.isLightTheme)}),this.themeElements={slider:r,knob:r,sunIcon:r,moonIcon:r,updateTheme:i}}applyTheme(e){var r,i,s;if(!document.getElementById("ytc-theme-styles")){let n=document.createElement("style");n.id="ytc-theme-styles";let o="";o+=".ytc-modal-light {",o+="--ytc-bg-primary: #fafbfc;",o+="--ytc-bg-secondary: #f0f2f5;",o+="--ytc-bg-tertiary: #e4e7eb;",o+="--ytc-bg-input: #ffffff;",o+="--ytc-text-primary: #1a1d21;",o+="--ytc-text-secondary: #4a5568;",o+="--ytc-text-muted: #718096;",o+="--ytc-border: #d1d5db;",o+="--ytc-border-focus: #0f766e;",o+="--ytc-accent: #0d9488;",o+="--ytc-accent-hover: #0f766e;",o+="--ytc-accent-gradient: linear-gradient(135deg, #0d9488 0%, #14b8a6 100%);",o+="--ytc-success: #10b981;",o+="--ytc-warning: #f59e0b;",o+="--ytc-error: #ef4444;",o+="--ytc-shadow: rgba(0, 0, 0, 0.08);",o+="--ytc-shadow-lg: 0 10px 40px rgba(0, 0, 0, 0.12);",o+="--ytc-glow: 0 0 20px rgba(13, 148, 136, 0.25);",o+="}",o+=".ytc-modal-dark {",o+="--ytc-bg-primary: #3f4042ff;",o+="--ytc-bg-secondary: #3f4042ff;",o+="--ytc-bg-tertiary: #3f4042ff;",o+="--ytc-bg-input: #16171a;",o+="--ytc-text-primary: #f4f4f5;",o+="--ytc-text-secondary: #a1a1aa;",o+="--ytc-text-muted: #71717a;",o+="--ytc-border: #3f3f46;",o+="--ytc-border-focus: #14b8a6;",o+="--ytc-accent: #14b8a6;",o+="--ytc-accent-hover: #0d9488;",o+="--ytc-accent-gradient: linear-gradient(135deg, #0d9488 0%, #14b8a6 100%);",o+="--ytc-success: #22c55e;",o+="--ytc-warning: #eab308;",o+="--ytc-error: #ef4444;",o+="--ytc-shadow: rgba(0, 0, 0, 0.4);",o+="--ytc-shadow-lg: 0 10px 40px rgba(0, 0, 0, 0.5);",o+="--ytc-glow: 0 0 30px rgba(20, 184, 166, 0.25);",o+="}",o+=".ytc-themed-modal .modal-content {",o+="background: var(--ytc-bg-secondary) !important;",o+="border-radius: 16px !important;",o+="border: 1px solid var(--ytc-border) !important;",o+="box-shadow: var(--ytc-shadow-lg), var(--ytc-glow) !important;",o+="padding: 24px !important;",o+="max-width: 520px !important;",o+="}",o+=".ytc-themed-modal .ytc-modal-header {",o+="background: linear-gradient(135deg, #f59e0b 0%, #fbbf24 50%, #f59e0b 100%) !important;",o+="-webkit-background-clip: text !important;",o+="-webkit-text-fill-color: transparent !important;",o+="background-clip: text !important;",o+="font-size: 1.5rem !important;",o+="font-weight: 700 !important;",o+="margin-bottom: 20px !important;",o+="text-align: center !important;",o+="width: 100% !important;",o+="display: block !important;",o+="}",o+='.ytc-themed-modal input[type="url"], .ytc-themed-modal input[type="text"] {',o+="background: var(--ytc-bg-input) !important;",o+="border: 2px solid var(--ytc-border) !important;",o+="border-radius: 10px !important;",o+="color: var(--ytc-text-primary) !important;",o+="transition: all 0.2s ease !important;",o+="}",o+=".ytc-themed-modal input:focus {",o+="border-color: var(--ytc-border-focus) !important;",o+="box-shadow: 0 0 0 3px rgba(20, 184, 166, 0.2) !important;",o+="}",o+=".ytc-themed-modal select {",o+="background: var(--ytc-bg-input) !important;",o+="border: 1px solid var(--ytc-border) !important;",o+="border-radius: 8px !important;",o+="color: var(--ytc-text-primary) !important;",o+="transition: all 0.2s ease !important;",o+="}",o+=".ytc-themed-modal select:hover {",o+="border-color: var(--ytc-accent) !important;",o+="}",o+=".ytc-themed-modal button {",o+="border-radius: 8px !important;",o+="font-weight: 500 !important;",o+="transition: all 0.2s ease !important;",o+="}",o+='.ytc-themed-modal .mod-cta, .ytc-themed-modal button[style*="interactive-accent"] {',o+="background: var(--ytc-accent-gradient) !important;",o+="border: none !important;",o+="color: white !important;",o+="box-shadow: 0 4px 14px rgba(21, 196, 190, 0.35) !important;",o+="}",o+=".ytc-themed-modal .mod-cta:hover {",o+="transform: translateY(-1px) !important;",o+="box-shadow: 0 6px 20px rgba(21, 196, 190, 0.45) !important;",o+="}",o+='.ytc-themed-modal [style*="font-weight: 500"] {',o+="color: var(--ytc-text-secondary) !important;",o+="}",n.innerHTML=o,document.head.appendChild(n)}(r=this.modalEl)==null||r.classList.add("ytc-themed-modal"),(i=this.modalEl)==null||i.classList.toggle("ytc-modal-light",e),(s=this.modalEl)==null||s.classList.toggle("ytc-modal-dark",!e),this.contentEl&&(this.contentEl.style.background="var(--ytc-bg-secondary)",this.contentEl.style.borderRadius="16px"),this.formatSelect&&(this.formatSelect.style.background="var(--ytc-bg-input)",this.formatSelect.style.color="var(--ytc-text-primary)",this.formatSelect.style.borderColor="var(--ytc-border)"),this.providerSelect&&(this.providerSelect.style.background="var(--ytc-bg-input)",this.providerSelect.style.color="var(--ytc-text-primary)",this.providerSelect.style.borderColor="var(--ytc-border)"),this.modelSelect&&(this.modelSelect.style.background="var(--ytc-bg-input)",this.modelSelect.style.color="var(--ytc-text-primary)",this.modelSelect.style.borderColor="var(--ytc-border)"),this.urlInput&&(this.urlInput.style.background="var(--ytc-bg-input)",this.urlInput.style.color="var(--ytc-text-primary)",this.urlInput.style.borderColor="var(--ytc-border)"),this.headerEl&&(this.headerEl.style.color="var(--ytc-text-primary)"),this.progressText&&(this.progressText.style.color="var(--ytc-text-primary)")}createProgressSection(){this.progressContainer=this.contentEl.createDiv(),this.progressContainer.setAttribute("role","region"),this.progressContainer.setAttribute("aria-label","Processing progress"),this.progressContainer.setAttribute("aria-live","polite"),this.progressContainer.style.marginTop="6px",this.progressContainer.style.display="none",this.progressText=this.progressContainer.createDiv(),this.progressText.id="progress-text",this.progressText.style.marginBottom="3px",this.progressText.style.fontWeight="500",this.progressText.style.fontSize="0.75rem",this.progressText.style.color="var(--text-accent)",this.progressText.textContent="Processing...";let e=this.progressContainer.createDiv();e.setAttribute("role","progressbar"),e.setAttribute("aria-valuenow","0"),e.setAttribute("aria-valuemin","0"),e.setAttribute("aria-valuemax","100"),e.setAttribute("aria-labelledby","progress-text"),e.style.width="100%",e.style.height="4px",e.style.backgroundColor="var(--background-modifier-border)",e.style.borderRadius="2px",e.style.overflow="hidden",this.progressBar=e.createDiv(),this.progressBar.style.height="100%",this.progressBar.style.backgroundColor="var(--interactive-accent)",this.progressBar.style.borderRadius="2px",this.progressBar.style.width="0%",this.progressBar.style.transition="width 0.3s ease"}createActionButtons(){let e=this.contentEl.createDiv();e.style.cssText=`
            display: flex;
            justify-content: flex-end;
            gap: 6px;
            margin-top: 8px;
